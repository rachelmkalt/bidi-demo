---
title: Integrate Overlay Checkout
excerpt: ''
deprecated: false
hidden: false
metadata:
...
Using the default button, and default events
...
If you need to customize the button, or add the payment process to an existing payment
